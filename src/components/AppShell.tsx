...
import imcLogoUrl from "@/assets/imc-logo.png";
  ...
  const menu = (
    <>
      <div className="app-sider-brand">
        <img src={imcLogoUrl} alt="Logo Industrial Measuring Center" className="app-sider-logo" loading="lazy" />
        <div className="app-sider-userinfo">
